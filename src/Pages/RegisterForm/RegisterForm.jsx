                    ...
                    <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="w-full">
                            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
                                ...
                                <form onSubmit={handleOnSubmit} id="signup-form" className="space-y-5">
...
{/* Password */}
                                    <div className="space-y-2">
                                        ...
                                        <div id="password-rules" className="text-xs text-gray-500 mt-1 space-y-1 hidden">
                                            <div id="rule-uppercase" className="flex items-center gap-1"><i className="fas fa-times text-red-500"></i> Must have an uppercase letter</div>
                                            <div id="rule-lowercase" className="flex items-center gap-1"><i className="fas fa-times text-red-500"></i> Must have a lowercase letter</div>
                                            <div id="rule-length" className="flex items-center gap-1"><i className="fas fa-times text-red-500"></i> Must be at least 6 characters</div>
                                        </div>
                                    </div>
{/* Confirm PassWord
                                    <div className="space-y-2">
...
{/* Terms Condition CheckBox */}
                                    <div className="flex items-start gap-3 py-2">
                                        <input type="checkbox" id="terms" className="w-5 h-5 mt-0.5 rounded-lg border-2 border-gray-300 text-primary focus:ring-2 focus:ring-primary/20 accent-primary cursor-pointer" required=""/>
